...
| radioSettings.channelCount          | `boolean`                       | Amount of Radio Channels available for the player.                                                                                                                                                                                                                  | Both       |
| radioSettings.mode                  | `'None' \| 'Direct' \| 'Tower'` | Enable or disable the radio towers.                                                                                                                                                                                                                                 | Both       |
| radioSettings.maxDistance           | `number`                        | The maximum distance in which the radio towers are available.                                                                                                                                                                                                       | Both       |
| radioSettings.towerPositions        | `[number, number, number][]`    | The positions of the radio towers.                                                                                                                                                                                                                                  | Both       |
