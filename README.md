...
| radioTowers.enabled                     | `boolean`                    | Enable or disable the radio towers.                                                                                                                                                                                      | Both       |
| radioTowers.maxDistance                 | `number`                     | The maximum distance in which the radio towers are available.                                                                                                                                                            | Both       |
| radioTowers.positions                   | `[number, number, number][]` | The positions of the radio towers.                                                                                                                                                                                       | Both       |
