...
export class YaCAClientIntercomModule {
    ...
    /**
     * Register the intercom exports.
     */
    registerExports() {
        /**
         * Adds or removes players from the intercom filter of the local player.
         *
         ...
         * @param {YacaSpeakerSettings} speakerSettings - The fixed loudspeakers the intercom is heard from. Optional,
         *                                               the intercom is heard from its owner when omitted.
         */
        exports('addRemovePlayerIntercomFilter', (playerIDs: number | number[], state: boolean, speakerSettings?: YacaSpeakerSettings) =>
            this.addRemovePlayerIntercomFilter(playerIDs, state, speakerSettings),
        )
    }
     ...
     *                                               from its owner when omitted.
     */
    addRemovePlayerIntercomFilter(playerIDs: number | number[], state: boolean, speakerSettings?: YacaSpeakerSettings) {
