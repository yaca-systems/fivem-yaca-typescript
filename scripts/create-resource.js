...
if (existsSync('config/yaca-voice/room_acoustics.json5')) {
    copyFileSync('config/yaca-voice/room_acoustics.json5', 'resource/yaca-voice/config/room_acoustics.json5')
}
